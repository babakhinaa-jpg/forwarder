...
# Allow binding to ports < 1024 and direct iptables access (CAP_NET_ADMIN)
# No CapabilityBoundingSet — sudo needs unrestricted bounding set to change uid/gid
# Security boundary is enforced by /etc/sudoers.d/port-forwarder (whitelist of allowed commands)
